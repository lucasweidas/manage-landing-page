    ...
    <header>
      <nav>
        <div>
          ...
          <button className="text-blue-900" aria-label="Open navigation menu">
        ...
        <div>
          <button className="text-blue-900" aria-label="Close navigation menu">
...
function Main() {
  return (
    <main>
      <section>
        <div>
          <Image src="/images/illustration-intro.svg" alt="" width={580} height={525} aria-hidden="true" />
        </div>
        <div>
      ...
      <section>
        ...
        <div>
          <ul>
            <li>
              <Image src="/images/avatar-anisha.png" alt="Anisha Li" width={144} height={144} />
              <h3 id="slider-title-0">Anisha Li</h3>
              <p>
                “Manage has supercharged our team’s workflow. The ability to maintain visibility on larger milestones at all times keeps everyone motivated.”
              </p>
            </li>
            <li>
              <Image src="/images/avatar-ali.png" alt="Ali Bravo" width={144} height={144} />
              <h3 id="slider-title-1">Ali Bravo</h3>
              <p>
            ...
            <li>
              <Image src="/images/avatar-richard.png" alt="Richard Watts" width={144} height={144} />
              <h3 id="slider-title-2">Richard Watts</h3>
              <p>
                “Manage allows us to provide structure and process. It keeps us organized and focused. I can’t stop recommending them to everyone I talk to!”
              </p>
            </li>
            <li>
              <Image src="/images/avatar-shanai.png" alt="Shanai Gough" width={144} height={144} />
              <h3 id="slider-title-3">Shanai Gough</h3>
              <p>
          ...
          <ul>
            <input type="radio" name="slider" id="slider-button-0" aria-labelledby="slider-title-0" />
            <input type="radio" name="slider" id="slider-button-1" aria-labelledby="slider-title-1" />
            <input type="radio" name="slider" id="slider-button-2" aria-labelledby="slider-title-2" />
            <input type="radio" name="slider" id="slider-button-3" aria-labelledby="slider-title-3" />
          </ul>
        </div>
        <a href="#">Get Started</a>
      </section>
...
function SVGContainer() {
  return (
    <svg className="hidden overflow-hidden" xmlns="http://www.w3.org/2000/svg">
      <symbol id="manage-logo" viewBox="0 0 146 24">
      ...
      <symbol id="hamburger-icon" viewBox="0 0 25 18">
        <g fill="currentColor" fillRule="evenodd">
          <path d="M0 0h25v4H0zM0 7h25v4H0zM0 14h25v4H0z" />
        </g>
      </symbol>
      <symbol id="close-icon" viewBox="0 0 21 22">
        <path
          fill="currentColor"
          fillRule="evenodd"
      ...
      <symbol id="social-youtube" viewBox="0 0 21 20">
        <path
          fill="currentColor"
      ...
      <symbol id="social-twitter" viewBox="0 0 21 18">
        <path
          fill="currentColor"
      ...
      <symbol id="social-instagram" viewBox="0 0 21 20">
        <path
          fill="currentColor"
